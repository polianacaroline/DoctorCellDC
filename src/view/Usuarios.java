...
public class Usuarios extends JDialog {
	...
	public Usuarios() {
		...
		btnLimpar.setBounds(98, 191, 52, 42);
		...
		getRootPane().setDefaultButton(btnPesquisar);
				...
				cboPerfil.setBounds(419, 10, 61, 22);
				...
				chckSenha.setBounds(362, 192, 118, 23);
				getContentPane().add(chckSenha);
				listUsers.addKeyListener(new KeyAdapter() {
					@Override
	...
	/**
	 * 
	 *  * metodo que busca o usuario da lista
	 */
